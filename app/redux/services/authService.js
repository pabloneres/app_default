 ...
 * @returns {Promise<T>}
 */
export const google = (options) => {
	return api.post(`${basePath}/google`, options);
};
 ...
 * @returns {Promise<T>}
 */
export const getCompanyByEmail = (options) => {
	return api_app.post(`${basePath}/login-type`, options);
};
