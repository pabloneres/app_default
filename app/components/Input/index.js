...
class UIInput extends Component {
	...
	render() {
		...
		let iconColor = this.state.focus ? this.getThemeConfig("iconColorFocus") : this.getThemeConfig("iconColor");
		let iconColorLeft = this.state.focus ? this.getThemeConfig("iconColorLeftFocus") : this.getThemeConfig("iconColorLeft");
		...
		inputStyle.push(this.state.focus ? this.getThemeConfig("inputStyleFocus") : this.getThemeConfig("inputStyle"));
				...
				<Animated.View style={elementStyle}>
					...
					{this.props.allowClear && !this.props.isLoading && this.state.value.length > 0 && (
						<TouchableOpacity
							...
							<UIIcon name="input-clear" size={9} color="#ACB3BF" />
						</TouchableOpacity>
					)}
					...
					{this.props.isSearch && (
						<TouchableOpacity
							...
							onPress={this.props.onPressButton}
							style={[styles.button, buttonStyle, this.props.buttonStyle]}>
							<UIIcon name="search-2" color={TEXT_COLOR_ALT} />
						</TouchableOpacity>
					)}
