...
class UIView extends Component {
	...
	render() {
		const { isContent, row, wrap, direction, flex, flexBasis, flexGrow, flexShrink, alignSelf, align, justify, width, height, radius, overflow, p, pt, pb, pl, pr, m, mt, mb, ml, mr, bg, style, ...rest } = this.props;
		...
		return <View
			{...rest}
			style={[styleNew, style, styleContent]}
		/>;
	}
}
